...
export default function CustomerBiltyDetailScreen() {
    ...
    const handleShare = async () => {
        ...
        try {
            ...
            console.error('[CustomerBiltyDetail] Share error', e);
        }
    };
    ...
    useEffect(() => {
        const load = async () => {
            ...
            try {
                ...
                console.error('[CustomerBiltyDetail] Error loading bilty', e);
    ...
    useEffect(() => {
        const loadParties = async () => {
            ...
            try {
                ...
                console.error('[CustomerBiltyDetail] Error loading parties', e);
            } finally {
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            ...
            <View style={styles.section}>
                ...
                <Text>{bilty.goodsDescription}</Text>
